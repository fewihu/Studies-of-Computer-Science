...
public class Server extends JFrame implements ActionListener, ChangeListener {
    ...
    try {
      ...
      if (frame != null) {
        ...
        if (fec.isReady()) {
          ...
          packet_bits = fec.getPacket();

          //TODO wieder entfernen
          FECpacket test = new FECpacket(packet_bits, packet_bits.length);
   ...
   */
  private String options() { return "Public: DESCRIBE, SETUP, TEARDOWN, PLAY, PAUSE" + CRLF; }
  ...
  private String describe() {
    ...
    rtspBody.write("o=fm 2890844526 2890842807 IN IP4 127.0.0.1" 			+ CRLF);
    rtspBody.write("s=HTW Image Trailer"	+ CRLF);
    rtspBody.write("c=IN IP4 127.0.0.1" + CRLF);
    rtspBody.write("m=video 20000 RTP/AVP 36"+ CRLF);
    rtspBody.write("a=rtpmap:36 MJPEG/90000" + CRLF + CRLF);

    rtspHeader.write("Content-Base: " + "rtsp://127.0.0.1:8554/" + VideoDir + "htw.mjpeg" + CRLF);
